...
<html lang="en">
    ...
    <head>
        <title>David Duong CS148</title>
        <meta charset="utf-8">
        <meta name="author" content="David Duong">
        <meta name="description" content="Take a look at my assignments through this site map">
        <link rel="stylesheet"
              href="style.css"
              type="text/css"/>
    ...
    <body>
    <figure class="small">
        <img class = "small" alt="David making duck face" src="assignment1.0/images/D.jpg">
    ...
    <ul>
        <li><a href="assignment3.0/join.php">Home Page</a></li>
         ...
         <li><a href="assignment3.0/q08.php">q08.php</a></li>
         <li><a href="assignment3.0/style.css">Style Sheet</a></li>
    </ul>
    ...
    <ul>
        <li><a href="assignment2.0/select.php">Home Page</a></li>
         ...
         <li><a href="assignment2.0/style.css">Style Sheet</a></li>
    </ul>
    
    <p> Assignment 1: </p>
   
    <ul>
        <li><a href="assignment1.0/index.php">Home Page</a></li>
         <li><a href="assignment1.0/tables.php">Tables.php</a></li>
        <li><a href="assignment1.0/css/base.css">Style Sheet</a></li>
    </ul>
