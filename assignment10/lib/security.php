...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "view.php";
    $whiteListPages[] = "add.php";
    $whiteListPages[] = "table.php";
    $whiteListPages[] = "cp3.php";
    $whiteListPages[] = "curry1.php";
    $whiteListPages[] = "kd8.php";
    $whiteListPages[] = "walladidas2.php";
    $whiteListPages[] = "kdtrey5.php";
